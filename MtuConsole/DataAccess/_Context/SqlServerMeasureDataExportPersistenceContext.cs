...
{
    public class SqlServerMeasureDataExportPersistenceContext : IMeasureDataPersistenceContext
    {
        ...
        public SqlServerMeasureDataExportPersistenceContext(string connectionString)
        {
        ...
        {
            return new SqlServer.SqlServerMeasureDataExportRepository(prerequisite);
        }
