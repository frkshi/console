...
{
    public class SqliteCollectionDataPersistenceContext : ICollectionDataPersistenceContext
    {
        ...
        public SqliteCollectionDataPersistenceContext(string filePath, FileSplitUnit splitUnit, int freeSpace)
        {
            this.FilePath = FileHelper.ReviseFilePath(filePath) + FolderNames.CollectionFolerName + "\\";
        ...
        {
            FileHelper.EnsureFolderExist(this.FilePath);
            string fullFileName = FileHelper.GetFullFileNameBySplitUnit(this.FilePath, "db3", this.FileSplitUnit);
            ...
            return new Sqlite.SqliteCollectionDataRepository(connectionString);
        }
